...
2. [Autoría con `.lab.md`](02-autoria-lab-md.md) — formato de la fuente única, `tools/lab_build.py`, ciclo de edición.
3. [Rúbricas](03-rubricas.md) — schema v1 y v2, autogeneración con Claude, `tools/rubric_build.py`, formato YAML en disco.
...
8. [Convenciones de `cell_id`](08-convenciones-cellids.md) — regex canónico, sufijos, ejercicios solo-análisis y multi-código.
...
|---|---|---|
| Compilador de fuente única `.lab.md` → `.ipynb` | [`tools/lab_build.py`](../tools/lab_build.py) | [02](02-autoria-lab-md.md) |
| Generador CLI de rúbrica YAML | [`tools/rubric_build.py`](../tools/rubric_build.py) | [03](03-rubricas.md) |
| Parche one-off para Lab 2 (split pregunta+respuesta) | [`tools/lab2_split_pregunta.py`](../tools/lab2_split_pregunta.py) | [10](10-troubleshooting.md) |
...
- **Si vas a autorear un lab nuevo:** [01](01-overview.md) → [02](02-autoria-lab-md.md) → [08](08-convenciones-cellids.md) → [03](03-rubricas.md).
