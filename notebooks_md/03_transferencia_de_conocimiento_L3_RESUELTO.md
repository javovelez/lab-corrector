<a href="https://colab.research.google.com/github/institutohumai/cursos-python/blob/master/CV/4_Transfer_Learning/ejercicios/ejercicios_solucion.ipynb"> <img src='https://colab.research.google.com/assets/colab-badge.svg' /> </a>
...
def content_loss(content_weight, content_current, content_original):
    ...
    # implementación 1
    # return content_weight * torch.sum(torch.square(content_current - content_original))

    # implementación 2
    N, C, H, W = content_current.shape
    content_current = content_current.reshape((N, C, H*W))
    N, C, H, W = content_original.shape
    content_original = content_original.reshape((N, C, H*W))
    return content_weight * torch.sum(torch.square(content_current - content_original))
...
def gram_matrix(features, normalize=True):
    ...
    return torch.matmul(features, torch.transpose(features, 1, 2)) / (H*W*C if normalize else 1)
...
def style_loss(feats, style_layers, style_targets, style_weights):
    ...
    for i in range(len(style_layers)):
        loss = loss + style_weights[i] * torch.sum(torch.square(gram_matrix(feats[style_layers[i]]) - style_targets[i]))
    return loss
...
def tv_loss(img, tv_weight):
    ...
    return tv_weight * (torch.sum(torch.square(img[:,:,1:,:] - img[:,:,:-1,:])) + 
                       torch.sum(torch.square(img[:,:,:,1:] - img[:,:,:,:-1])))
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_34_0.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_34_2.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_34_4.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_34_6.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_35_0.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_35_2.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_35_4.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_35_6.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_36_0.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_36_2.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_36_4.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_36_6.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_37_0.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_37_2.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_37_4.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_37_6.png)
...
<img src='https://storage.googleapis.com/humai-datasets/imagenes/imagen/4_Transfer_Learning/0_image.png' />
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_40_0.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_40_2.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_40_4.png)
...
![png](03_transferencia_de_conocimiento_L3_RESUELTO_files/03_transferencia_de_conocimiento_L3_RESUELTO_40_6.png)
